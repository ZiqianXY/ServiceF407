...
u8 atk_8266_wifista_test(void)
{
    ...
    while(atk_8266_send_cmd(p,"OK",5000))  printf("...尝试重新连接...");//连接目标路由器,并且获得IP
        
    
    printf("\r\n===获取ip信息\r\n");
    atk_8266_get_ip(ipbuf);//获取WAN IP
    ...
    printf("\r\n===访问服务器：%s\r\n",p+12);
    while(atk_8266_send_cmd(p,"OK",2000))    printf(">>>访问指定地址失败，重试...\r\n");
    printf(">>>访问指定地址成功\r\n");
